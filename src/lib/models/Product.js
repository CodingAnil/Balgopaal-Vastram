  ...
  sizes: {
    ...
    validate: {
      validator: function(sizes) {
        ...
        return sizes.length > 0 && sizes.every(size => validSizes.includes(size))
      },
  ...
  colors: {
    ...
    validate: {
      validator: function(colors) {
        return colors.length > 0 && colors.every(color => color.trim().length > 0)
      },
  ...
  images: {
    ...
    validate: {
      validator: function(images) {
        return images.length > 0 && images.every(image => image.trim().length > 0)
      },
