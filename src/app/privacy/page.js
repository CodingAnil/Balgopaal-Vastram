...
export const metadata = {
  ...
  description:
    'Privacy policy for Balgopaal Vastram - How we collect, use, and protect your personal information',
  keywords:
    'privacy, policy, data protection, Balgopaal Vastram, personal information',
}
        ...
        <div className="rounded-lg bg-white p-8 shadow-md">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-6 text-gray-700">
              At Balgopaal Vastram, we are committed to protecting your privacy
            ...
            <p className="mb-6 text-gray-700">
              ...
              to valid legal requests from government authorities or law
            ...
            <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
              <p className="text-sm text-blue-800">
                ...
                the date listed above and will remain in effect except with
                respect to any changes in its provisions in the future, which
